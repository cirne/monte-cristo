  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-stone-900">All Chapters</h1>
        <p className="text-stone-500 mt-1">{book.chapters.length} chapters across 5 volumes</p>
      </div>

      <div className="space-y-10">
        {chaptersByVolume.map(({ key, label, chapters }) => (
          <section key={key}>
            <h2 className="text-sm font-bold uppercase tracking-widest text-stone-400 border-b border-stone-200 pb-2 mb-4">
